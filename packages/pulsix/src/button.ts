// packages/pulsix/src/button.ts

import { openTransactionPopup, PopupConfig } from './popup';

let ButtonClass: any = null; // Inizializza a null (o una classe fittizia se preferisci)

// Definisci la classe *solo* se HTMLElement esiste (quindi, nel browser)
